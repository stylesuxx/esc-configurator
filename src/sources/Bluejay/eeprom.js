const BLUEJAY_EEPROM_OFFSET = 0x1A00;
const BLUEJAY_PAGE_SIZE = 0x0200;
...
const BLUEJAY_LAYOUT_SIZE = 0x70;

const BLUEJAY_TYPES = { EFM8: 'EFM8' };

const BLUEJAY_LAYOUT = {
  MAIN_REVISION: {
    offset: 0x00,
    size: 1,
  },
...
const BLUEJAY_INDIVIDUAL_SETTINGS = [
  {
...
const BLUEJAY_INDIVIDUAL_SETTINGS_DESCRIPTIONS = {
...
const EEPROM = {
  DEFAULTS: BLUEJAY_DEFAULTS,
  EEPROM_OFFSET: BLUEJAY_EEPROM_OFFSET,
  INDIVIDUAL_SETTINGS_DESCRIPTIONS: BLUEJAY_INDIVIDUAL_SETTINGS_DESCRIPTIONS,
  LAYOUT: BLUEJAY_LAYOUT,
  LAYOUT_SIZE: BLUEJAY_LAYOUT_SIZE,
  NAMES: BLUEJAY_NAMES,
  PAGE_SIZE: BLUEJAY_PAGE_SIZE,
  SETTINGS_DESCRIPTIONS: BLUEJAY_SETTINGS_DESCRIPTIONS,
  TYPES: BLUEJAY_TYPES,
};
