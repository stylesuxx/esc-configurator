...
test('loads and displays CustomSettings', () => {
  const availableSettings = {
    LAYOUT_REVISION: 203,
    MAIN_REVISION: 1,
    NAME: 'FW name',
...
test('handles setting adjustments', () => {
  const availableSettings = {
    LAYOUT_REVISION: 203,
    MAIN_REVISION: 1,
    NAME: 'FW name',
...
test('handles setting adjustments with direct input', () => {
  const availableSettings = {
    LAYOUT_REVISION: 203,
    MAIN_REVISION: 1,
    NAME: 'FW name',
...
test('shows error if not all MULTI', () => {
  const availableSettings = {
    LAYOUT_REVISION: 203,
    MAIN_REVISION: 1,
    NAME: 'FW name',
...
test('handles out of sync settings', () => {
  const availableSettings = {
    LAYOUT_REVISION: 201,
    MAIN_REVISION: 0,
    NAME: 'FW name',
...
test('handles setting overrides', () => {
  const availableSettings = {
    LAYOUT_REVISION: 201,
    MAIN_REVISION: 0,
    NAME: 'FW name',
